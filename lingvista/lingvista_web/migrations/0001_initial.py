    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='profile', to='lingvista_web.customuser')),
            ],
        ),
        migrations.CreateModel(
            name='Task',
            fields=[
                ...
                ('lesson', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tasks', to='lingvista_web.lesson')),
            ],
        ),
        migrations.CreateModel(
            name='UserProgress',
