...
from lingvista_web.views import custom_logout
from django.contrib.auth import views as auth_views

urlpatterns = [
    path('admin/', admin.site.urls),
    path('', views.main_page, name='main_page'),  # Главная страница (name='main_page')
    ...
    path('account_page/', views.profile_view, name='profile_view'),  # Исправлено имя
